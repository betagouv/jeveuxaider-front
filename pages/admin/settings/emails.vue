  ...
  data () {
    return {
      ...
      notifications: [
        ...
        { tab: 'benevoles', key: 'user_banned_not_regular_resident_or_younger_than_16', label: 'Vous avez été automatiquement désinscrit de la plateforme JeVeuxAider.gouv.fr', description: 'Notification envoyée au bénévole quand un administrateur bloque son compte car il ne réside pas régulièrement en France ou est agé de moins de 16 ans', tags: ['app-benevole-banni-ne-reside-pas-en-france-ou-moins-de-16-ans'], is_updated: true },
