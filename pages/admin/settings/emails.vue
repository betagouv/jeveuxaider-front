...
export default {
  ...
  data () {
    return {
      ...
      notifications: [
        { tab: 'benevoles', key: 'benevole_register', label: '💪 Une dernière étape pour s’engager [PRENOM] !', description: 'Le bénévole vient de s’inscrire sur JVA et reçoit une première proposition de mission', tags: ['app-benevole-inscription'], is_updated: true },
        ...
        { tab: 'benevoles', key: 'benevole_message_participation', label: 'Nouveau message de la part de [PRENOM]', description: 'Le responsable de mission a envoyé un message au bénévole', tags: ['app-benevole-nouveau-message'], is_updated: true },
        { tab: 'benevoles', key: 'benevole_marketplace_mission', label: '[NOM-ORGA] vous propose une mission de bénévolat', description: 'Notification envoyée via la marketplace inversée' },
        { tab: 'benevoles', key: 'register_user_volontaire_cej', label: '[PRENOM], avec le Contrat d’Engagement Jeune, réalisez des missions de bénévolat !', description: 'Notification envoyée au bénévole 3 jours après avoir indiqué être engagé CEJ' },
        { tab: 'benevoles', key: 'benevole_cej_no_participation', label: '[PRENOM], votre première mission de bénévolat vous attend sur JeVeuxAider.gouv.fr', description: "Notification envoyée au bénévole engagé CEJ s'il n'a toujours pas de participation 10 jours après son inscription" },
        { tab: 'benevoles', key: 'benevole_cej_six_months_after', label: '[PRENOM], êtes-vous toujours en Contrat d’Engagement Jeune ?', description: 'Notification envoyée au bénévole engagé CEJ 6 mois et 1 an après ajout de la mention CEJ sur le profil' },
        { tab: 'benevoles', key: 'benevole_participation_should_be_done', label: 'Avez-vous réalisé votre mission ?', description: 'Notification envoyée au bénévole lorsque sa participation est toujours en attente de validation / en cours de traitement alors que la mission est censée être terminée. Pour les missions ponctuelles, la notification est envoyée 1 jour après la date de fin de la mission. Pour les missions récurrentes ou sans date de fin, 1 mois après la création de la participation.', tags: ['app-benevole-participation-should-be-done'], is_updated: true },
        { tab: 'benevoles', key: 'user_banned_not_regular_resident', label: 'Vous avez été automatiquement désinscrit de la plateforme JeVeuxAider.gouv.fr', description: 'Notification envoyée au bénévole quand un administrateur bloque son compte car il ne réside pas régulièrement en France', tags: ['app-benevole-banni-ne-reside-pas-en-france'], is_updated: true },
        { tab: 'benevoles', key: 'user_banned_younger_than_16', label: 'Vous avez été automatiquement désinscrit de la plateforme JeVeuxAider.gouv.fr', description: 'Notification envoyée au bénévole quand un administrateur bloque son compte car il est agé de moins de 16 ans', tags: ['app-benevole-banni-moins-de-16-ans'], is_updated: true },
        { tab: 'responsables', key: 'responsable_mission_deactivated', label: 'Votre mission a été désactivée', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur désactive l'une de ses missions", tags: ['app-responsable-mission-desactivee'], is_updated: true },
        { tab: 'responsables', key: 'responsable_mission_reactivated', label: 'Votre mission est de nouveau active 👏🏻', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur réactive l'une de ses missions", tags: ['app-responsable-mission-reactivee'], is_updated: true },
        { tab: 'responsables', key: 'responsable_missions_deactivated', label: 'Vos missions ont été désactivées', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur désactive toutes ses missions", tags: ['app-responsable-missions-desactivees'], is_updated: true },
        { tab: 'responsables', key: 'responsable_missions_reactivated', label: 'Vos missions sont de nouveau actives 👏🏻', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur réactive toutes ses missions", tags: ['app-responsable-missions-desactivees'], is_updated: true },
        ...
        { tab: 'responsables', key: 'responsable_mission_outdated_first_reminder', label: 'Votre mission a-t-elle pris fin ?', description: 'Notification envoyée au responsable lorsque sa mission a une date de fin passée depuis 5 jours', tags: ['app-responsable-relance-mission-passee-1'], is_updated: true },
        { tab: 'responsables', key: 'responsable_mission_outdated_second_reminder', label: 'Votre mission va être clôturée', description: 'Notification envoyée au responsable lorsque sa mission a une date de fin passée depuis 20 jours', tags: ['app-responsable-relance-mission-passee-2'], is_updated: true },
        ...
        { tab: 'responsables', key: 'responsable_participation_created', label: 'Vous avez une nouvelle demande de participation 👊', description: "Le responsable reçoit uen notification lorsqu'un bénévole souhaite participer à une mission", tags: ['app-responsable-participation-en-attente-de-validation'], is_updated: true },
        ...
        { tab: 'responsables', key: 'responsable_participation_validated_by_benevole', label: 'Nouvelle participation validée ✔️', description: "Notification envoyée au responsable lorsqu'une participation est validée par le bénévole", tags: ['app-responsable-participation-validee-par-benevole'], is_updated: true },
        ...
        { tab: 'responsables', key: 'responsable_no_new_mission', label: 'Vous nous manquez sur JeVeuxAider.gouv.fr !', description: "Notification envoyée au responsable si aucune mission n'est postée en 3 mois", tags: ['app-responsable-no-new-mission'], is_updated: true },
        { tab: 'responsables', key: 'responsable_participations_need_to_be_treated', label: 'XX bénévoles attendent une réponse au plus vite ! 🙌', description: 'Rappel envoyé au responsable si des participations doivent être traitées en priorité', tags: ['app-responsable-rappel-participations-a-traiter-en-priorite'], is_updated: true },
        { tab: 'responsables', key: 'structure_switch_responsable', label: '[PRENOM-NOM] vous a confié la gestion de nouvelles missions', description: "Lorsque'un responsable quitte l'organisation ou se désinscrit" },
        { tab: 'responsables', key: 'structure_unregister_contact_admin', label: '[NOM-ORGA] souhaite se désinscrire...', description: "Lorsque'un responsable ne peut pas se désinscrire (car participations reliées à sa structure)" },
        ...
        { tab: 'responsables', key: 'responsable_message_participation', label: '[PRENOM] vous a envoyé un nouveau message !', description: 'Le bénévole a envoyé un message au responsable à propos de sa candidature', tags: ['app-responsable-nouveau-message-participation'], is_updated: true },
        ...
        { tab: 'responsables', key: 'responsable_organisation_without_mission_first_reminder', label: '[PRENOM], avez-vous besoin de bénévoles ?', description: 'Mail envoyé au responsable au bout de 10 jours si son organisation n\'a toujours pas de mission', tags: ['app-responsable-publication-mission'], is_updated: true },
        { tab: 'responsables', key: 'responsable_organisation_without_mission_second_reminder', label: 'Les bénévoles n’attendent plus que vous !', description: 'Mail envoyé au responsable au bout de 30 jours si son organisation n\'a toujours pas de mission', tags: ['app-responsable-publication-mission-relance'], is_updated: true },
        ...
        { tab: 'referents', key: 'referent_mission_created', label: '[PRENOM], vous avez une nouvelle mission à modérer', description: "Notification envoyée aux référents du département lorsqu'une mission est postée", tags: ['app-referent-mission-en-attente-de-validation'], is_updated: true },
        { tab: 'referents', key: 'referent_organisation_created', label: '[PRENOM], une nouvelle organisation vient de s’inscrire sur JeVeuxAider.gouv.fr !', description: "Notification envoyée aux référents du département lorsqu'une organisation s'inscrit et est en attente de validation", tags: ['app-referent-organisation-en-attente-de-validation'], is_updated: true },
        { tab: 'referents', key: 'referent_waiting_actions', label: 'Ça bouge dans votre département !', description: "Notification envoyée aux référents lorsqu'ils ont des actions en attente", tags: ['app-referent-daily-todo'], is_updated: true },
        { tab: 'referents', key: 'referent_summary_daily', label: '[PRENOM], on vous passe le relais !', description: "Notification envoyée aux référents lorsqu'ils ont activé le résumé bi-hebdomadaire dans leurs préférences de notification", tags: ['app-referent-bilan-quotidien'], is_updated: true },
        { tab: 'referents', key: 'referent_summary_monthly', label: '[PRENOM], découvrez le résumé mensuel de l’activité sur JeVeuxaider.gouv.fr !', description: "Notification envoyée aux référents lorsqu'ils ont activé le résumé mensuel dans leurs préférences de notification", tags: ['app-referent-bilan-mensuel'], is_updated: true },
        ...
        { tab: 'other', key: 'mission_template_created', label: '[NOM-RESEAU]: Nouveau modèle de mission en attente de validation', description: "Lorsqu'un réseau créé un nouveau template de mission" },
        ...
        { tab: 'other', key: 'register_user_volontaire_cej_adviser', label: '[PRENOM-NOM] s’est inscrit sur JeVeuxAider.gouv.fr', description: "Envoyé au conseiller CEJ lorqu'un bénévole s'inscrit sur la plateforme" },
        { tab: 'other', key: 'participation_validated_cej_adviser', label: '[PRENOM-NOM] s’est inscrit sur une mission de bénévolat', description: "Envoyé au conseiller CEJ lorqu'un bénévole s'inscrit à une mission" },
