  ...
  data () {
    return {
      ...
      notifications: [
        ...
        { tab: 'responsables', key: 'responsable_register', label: 'Votre organisation est en cours de validation', description: "Notification envoyée au responsable d'organisation lorsque le statut passe de Brouillon à En attente de validation" },
        { tab: 'responsables', key: 'responsable_still_in_draft', label: 'Finalisez votre inscription sur JeVeuxAider.gouv.fr', description: "Notification envoyée au responsable d'organisation lorsque son organisation est toujours en Brouillon. (J+1, J+7, J+15)" },
        { tab: 'responsables', key: 'responsable_organisation_being_processed', label: 'Organisation en cours de traitement', description: 'Notification envoyée au responsable lorsque son organisation est en cours de traitement' },
        { tab: 'responsables', key: 'responsable_organisation_validated', label: 'Votre organisation a été validée', description: 'Notification envoyée au responsable lorsque son organisation est validée' },
        { tab: 'responsables', key: 'responsable_association_validated', label: 'Bienvenue sur JeVeuxAider.gouv.fr', description: 'Notification envoyée au responsable lorsque son organisation de type association est validée', tags: ['app-organisation-validee'] },
        { tab: 'responsables', key: 'responsable_collectivite_validated', label: 'Organisation de type collectivité territoriale validée', description: 'Notification envoyée au responsable lorsque son organisation de type collectivité territoriale est validée' },
        { tab: 'responsables', key: 'responsable_organisation_signaled', label: 'Votre organisation a été signalée', description: 'Notification envoyée au responsable lorsque son organisation est signalée' },
        { tab: 'responsables', key: 'responsable_mission_created', label: 'Votre mission a bien été déposée', description: "Notification envoyée au responsable lorsqu'une mission est postée" },
        { tab: 'responsables', key: 'responsable_mission_validated', label: 'Votre mission est validée !', description: 'Notification envoyée au responsable lorsque sa mission est validée' },
        { tab: 'responsables', key: 'responsable_mission_being_processed', label: 'Votre mission est en cours de traitement', description: 'Notification envoyée au responsable lorsque sa mission est en cours de traitement' },
        ...
        { tab: 'responsables', key: 'responsable_mission_almost_full', label: 'Votre mission XXX est bientôt complète ?', description: "Notification envoyée au responsable lorsque sa mission n'a plus qu'une seule place restante" },
        { tab: 'responsables', key: 'responsable_mission_signaled', label: 'Votre mission a été signalée', description: 'Notification envoyée au responsable lorsque sa mission est signalée' },
        { tab: 'responsables', key: 'responsable_participation_created', label: 'Vous avez une nouvelle demande de participation', description: "Notification envoyée au responsable lorsqu'un bénévole souhaite participer à une mission", tags: ['app-organisation-participation-en-attente-de-validation'] },
        { tab: 'responsables', key: 'responsable_participation_canceled', label: 'Une participation a été annulée', description: "Notification envoyée au responsable lorsqu'une participation est annulée par le bénévole" },
        { tab: 'responsables', key: 'responsable_missin_in_draft', label: 'Votre mission XXX est restée au statut « Brouillon »', description: 'Notification envoyée au responsable si une mission est restée au statut brouillon 7 jours' },
        { tab: 'responsables', key: 'responsable_no_new_mission', label: 'Publiez une nouvelle mission sur JeVeuxAider.gouv.fr', description: "Notification envoyée au responsable si aucune mission n'est postée en 3 mois" },
        { tab: 'responsables', key: 'responsable_waiting_actions', label: 'Des bénévoles attendent votre réponse !', description: 'Rappel envoyé au responsable si des participations sont toujours en attente de validation', tags: ['app-organisation-rappel-participations-en-attente-de-validation'] },
