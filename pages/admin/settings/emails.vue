      ...
      notifications: [
        {
          ...
          description: 'Le bénévole vient de s’inscrire sur JVA et reçoit une première proposition de mission',
        ...
        },
        {
          ...
          description: 'Le référent a répondu au premier message du bénévole ou a besoin d’informations complémentaires et a donc passé la mission à “En cours de traitement”',
        ...
        },
        {
          ...
          description: 'Le bénévole a reçu une réponse positive suite à sa candidature sur une mission de bénévolat',
        ...
        },
        {
          ...
          description: 'Le responsable de mission a passé la mission au statut Terminé. Le bénévole est invité à partager son retour d’expérience.',
        ...
        },
        {
          ...
          description: 'Le responsable a refusé la candidature proposée par le bénévole. Ce dernier a une précision sur les raisons de refus de sa proposition de participation.',
        ...
        },
        {
          ...
          description: 'Le responsable annule la mission : elle n’a finalement pas lieu pour une raison X ou Y (il pleut, pas assez de bénévoles)',
        ...
        },
        {
          ...
          description: "Notification envoyée au bénévole engagé CEJ s'il n'a toujours pas de participation 10 jours après son inscription"
        },
        {
          tab: 'benevoles',
          key: 'benevole_cej_six_months_after',
          label: '[PRENOM], êtes-vous toujours en Contrat d’Engagement Jeune ?',
          description: 'Notification envoyée au bénévole engagé CEJ 6 mois et 1 an après ajout de la mention CEJ sur le profil'
        },
        {
          tab: 'benevoles',
          key: 'benevole_participation_should_be_done',
          label: 'Avez-vous réalisé votre mission ?',
          description: 'Notification envoyée au bénévole lorsque sa participation est toujours en attente de validation / en cours de traitement alors que la mission est censée être terminée. Pour les missions ponctuelles, la notification est envoyée 1 jour après la date de fin de la mission. Pour les missions récurrentes ou sans date de fin, 1 mois après la création de la participation.',
        ...
        },
        {
          ...
          description: 'Notification envoyée au bénévole quand un administrateur bloque son compte car il ne réside pas régulièrement en France',
        ...
        },
        {
          ...
          label: 'Vous avez été automatiquement désinscrit de la plateforme JeVeuxAider.gouv.fr',
          description: 'Notification envoyée au bénévole quand un administrateur bloque son compte car il est agé de moins de 16 ans',
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur désactive l'une de ses missions",
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur réactive l'une de ses missions",
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur désactive toutes ses missions",
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur réactive toutes ses missions",
          tags: ['app-responsable-missions-desactivees'],
          types: ['Notification']
        },
        {
          ...
          description: "Notification envoyée au responsable d'organisation lorsque le statut passe de Brouillon à En attente de validation",
        ...
        },
        {
          ...
          description: "Notification envoyée aux membres de l'organisation lorsqu'elle est toujours en Brouillon. (J+1, J+7, J+15)",
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable lorsque son organisation est en cours de traitement',
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable lorsqu'une mission est postée et est en attente de validation",
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable lorsque sa mission est en cours de traitement',
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable lorsque sa mission a une date de fin passée depuis 5 jours',
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable lorsque sa mission a une date de fin passée depuis 20 jours',
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable lorsque sa mission n'a plus qu'une seule place restante",
        ...
        },
        {
          ...
          description: "Le responsable reçoit uen notification lorsqu'un bénévole souhaite participer à une mission",
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable lorsque son organisation de type association est validée',
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable lorsque son organisation de type collectivité territoriale est validée',
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable lorsqu'une participation est annulée par le bénévole",
        ...
        },
        {
          ...
          description: "Notification envoyée au responsable lorsqu'une participation est validée par le bénévole",
        ...
        },
        {
          ...
          description: 'Notification envoyée au responsable si une mission est restée au statut brouillon 7 jours',
        ...
        },
        {
          ...
          description: 'Rappel envoyé au responsable si des participations doivent être traitées en priorité',
        ...
        },
        {
          ...
          description: "Lorsque'un responsable ne peut pas se désinscrire (car participations reliées à sa structure)"
        },
        {
          tab: 'responsables',
          key: 'responsable_summary_daily',
          label: '[PRENOM], découvrez l’activité du jour sur JeVeuxAider.gouv.fr !',
          description: "Notification envoyée aux responsables lorsqu'ils ont activé le résumé quotidien dans leurs préférences de notification"
        },
        {
          tab: 'responsables',
          key: 'responsable_summary_monthly',
          label: '[PRENOM], découvrez votre résumé mensuel d’activité sur JeVeuxaider.gouv.fr !',
          description: "Notification envoyée aux responsables lorsqu'ils ont activé le résumé mensuel dans leurs préférences de notification"
        },
        {
          tab: 'responsables',
        ...
        },
        {
          ...
          description: 'Mail envoyé au responsable au bout de 10 jours si son organisation n\'a toujours pas de mission',
        ...
        },
        {
          ...
          description: 'Mail envoyé au responsable au bout de 30 jours si son organisation n\'a toujours pas de mission',
        ...
        },
        {
          ...
          description: "Notification envoyée aux référents du département lorsqu'une organisation s'inscrit et est en attente de validation",
        ...
        },
        {
          ...
          description: "Notification envoyée aux référents lorsqu'ils ont activé le résumé bi-hebdomadaire dans leurs préférences de notification",
        ...
        },
        {
          ...
          description: "Notification envoyée aux référents lorsqu'ils ont activé le résumé mensuel dans leurs préférences de notification",
        ...
        },
        {
          ...
          description: "Notification envoyée aux référents et/ou responsable lorsqu'un nouveau document est postée",
          types: ['Notification']
        },
        {
          tab: 'other',
