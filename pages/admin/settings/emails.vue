      ...
      groups: [
        ...
        },
        {
          ...
          notifications: [
            ...
            { key: 'responsable_organisation_validated', label: 'Bienvenue sur JeVeuxAider.gouv.fr', description: 'Notification envoyée au responsable lorsque son organisation est validée' },
            ...
            { key: 'responsable_mission_validated', label: 'Mission validée', description: 'Notification envoyée au responsable lorsque sa mission est validée' },
