  ...
  data () {
    return {
      ...
      notifications: [
        ...
        { tab: 'responsables', key: 'responsable_mission_outdated', label: 'Votre mission [NOM-MISSION] a-t-elle pris fin ?', description: 'Notification envoyée au responsable lorsque sa mission a une date de fin périmée de plus de 15 jours' },
        ...
        { tab: 'responsables', key: 'responsable_organisation_without_mission_first_reminder', label: '[PRENOM], avez-vous besoin de bénévoles ?', description: 'Mail envoyé au responsable au bout de 10 jours si son organisation n\'a toujours pas de mission', tags: ['app-responsable-organisation-sans-mission-1'], is_updated: true },
        { tab: 'responsables', key: 'responsable_organisation_without_mission_second_reminder', label: 'Les bénévoles n’attendent plus que vous !', description: 'Mail envoyé au responsable au bout de 30 jours si son organisation n\'a toujours pas de mission', tags: ['app-responsable-organisation-sans-mission-2'], is_updated: true },
