...
const notifications = [
  ...
  },
  {
    ...
    key: 'mission_user_waiting_list_registration_closed_created',
    label: 'Un bénévole aimerait proposer son aide pour votre mission',
    description: 'Le responsable est informé qu’un bénévole est en liste d’attente',
    workflows: ['liste-attente'],
    brevoTags: ['app-responsable-mission-user-waiting-list-registration-closed-created'],
    weight: 90,
    tags: ['Inscriptions fermées'],
    databaseNotification: false,
  },
  {
    receiver: 'responsable',
    key: 'mission_user_waiting_list_no_place_left_created',
    label: 'Un bénévole aimerait proposer son aide pour votre mission',
    description: 'Le responsable est informé qu’un bénévole est en liste d’attente',
    workflows: ['liste-attente'],
    brevoTags: ['app-responsable-mission-user-waiting-list-no-place-left-created'],
    weight: 90,
  ...
  {
    receiver: 'benevole',
    key: 'mission_user_waiting_list_created_3_weeks_ago',
    label: '[PRENOM], des missions de bénévolat vous attendent',
    description: 'Le bénévole est en liste d’attente depuis 3 semaines',
    workflows: ['liste-attente'],
    brevoTags: ['app-benevole-mission-user-waiting-list-created-3-weeks-ago'],
    weight: 90,
    tags: ['Mission complète'],
    databaseNotification: false,
  },
