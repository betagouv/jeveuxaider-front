  ...
  data () {
    return {
      ...
      notifications: [
        ...
        { tab: 'responsables', key: 'responsable_participation_validated_by_benevole', label: '✅ [PRENOM-NOM] a validé sa participation', description: "Notification envoyée au responsable lorsqu'une participation est validée par le bénévole", tags: ['app-responsable-participation-validee-par-benevole'], is_updated: true },
        ...
        { tab: 'responsables', key: 'responsable_waiting_actions', label: 'Vous avez des participations à traiter en priorité ! 🙌', description: 'Rappel envoyé au responsable si des participations sont toujours en attente de validation', tags: ['app-responsable-rappel-participations-en-attente-de-validation'], is_updated: true },
