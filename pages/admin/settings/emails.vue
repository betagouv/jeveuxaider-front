  ...
  data () {
    return {
      ...
      notifications: [
        ...
        { tab: 'responsables', key: 'responsable_mission_outdated_second_reminder', label: 'Votre mission va être clôturée', description: 'Notification envoyée au responsable lorsque sa mission a une date de fin passée depuis 15 jours', tags: ['app-responsable-relance-mission-passee-2'], is_updated: true },
