  ...
  data () {
    return {
      ...
      notifications: [
        ...
        { tab: 'responsables', key: 'responsable_mission_deactivated', label: 'Votre mission a été désactivée par un modérateur', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur désactive l'une de ses missions", tags: ['app-responsable-mission-desactivee'], is_updated: true },
        { tab: 'responsables', key: 'responsable_mission_reactivated', label: 'Votre mission a été réactivée ! 🎉', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur réactive l'une de ses missions", tags: ['app-responsable-mission-reactivee'], is_updated: true },
        { tab: 'responsables', key: 'responsable_missions_deactivated', label: 'Vos missions ont été désactivées par un modérateur', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur désactive toutes ses missions", tags: ['app-responsable-missions-desactivees'], is_updated: true },
        { tab: 'responsables', key: 'responsable_missions_reactivated', label: 'Vos missions ont été réactivées ! 🎉', description: "Notification envoyée au responsable d'organisation lorsqu'un modérateur réactive toutes ses missions", tags: ['app-responsable-missions-desactivees'], is_updated: true },
