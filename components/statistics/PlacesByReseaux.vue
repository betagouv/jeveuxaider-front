<template>
  <BaseBox padding="sm" :loading="loading" loading-text="Récupération des réseaux...">
    <BoxHeadingStatistics
      title="Réseaux avec le plus de places"
      no-period
      class="mb-6"
      infos-bulle="Liste des réseaux avec le plus de places disponibles en ce moment"
    />
...
export default defineNuxtComponent({
  ...
  methods: {
    async fetch() {
      this.loading = true
      await apiFetch('/statistics/public/places-by-reseaux', {
