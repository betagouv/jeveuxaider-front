<template>
  <Box padding="sm" :loading="loading" loading-text="Générations des données...">
    <BoxHeadingStatistics title="Types des missions" class="mb-6" infos-bulle="Répartition des missions validées, créées sur la période par type" />
    <div class="w-full">
...
export default {
  ...
  async fetch () {
    this.loading = true
    await this.$axios.get('/statistics/public/missions-by-types', {
