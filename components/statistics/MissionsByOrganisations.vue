<template>
  <Box padding="sm" :loading="loading" loading-text="Récupération des organisations...">
    <BoxHeadingStatistics title="Organisations les plus actives" class="mb-6" infos-bulle="Liste des organisations ayant le plus de missions validées sur la période sélectionnée" />
