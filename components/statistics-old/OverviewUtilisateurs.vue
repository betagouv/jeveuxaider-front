<template>
  <Box padding="sm" :loading="loading" loading-text="Générations des données...">
    <BoxHeadingStatistics title="Vue d'ensemble" class="mb-6" />
    ...
    <div v-if="statistics" class="grid grid-cols-1 lg:grid-cols-4 border bg-gray-200 gap-[1px] overflow-hidden">
      <CardStatistic
        ...
        :infos-bulle="`Correspond au nombre d'utilisateurs inscrits`"
      />
      <CardStatistic
        ...
        :infos-bulle="`Correspond au nombre de bénévoles inscrits`"
      />
    </div>
  </Box>
</template>
