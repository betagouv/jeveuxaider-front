      ...
      <div class="flex flex-col justify-between items-center sm:flex-row gap-12">
        <div class="flex flex-col space-y-4 xl:space-y-8 max-w-[740px]">
          <p class="font-bold text-jva-blue-500 uppercase xl:text-xl">
            Action citoyenne le 8 ou 9 juin 2024
          </p>
          <DsfrHeading as="h2" size="alt-sm">
            <span>Rejoignez un bureau de vote </span>
            <br class="hidden lg:block" />
            <span>lors des élections européennes</span>
          </DsfrHeading>
          <p
          ...
          >
            ...
            recherchent des assesseurs bénévoles. Faites vivre la démocratie et prononcez l’iconique
            “à voté !”
          </p>
        </div>
        <img
          src="/images/operations/elections-europeennes.png"
          alt="Elections européennes 2024"
          width="383"
          height="384"
      ...
      <div class="mt-12">
        ...
        <AlgoliaSlideshowMissions
          ...
          :search-parameters="{
            ...
            facetFilters: [['tags:Elections européennes 2024']],
    ...
    onViewMoreClick() {
      this.$plausible.trackEvent('Homepage - CTA - Plus de missions - Opé nationale', {
        props: {
          ...
          operation: 'Elections européennes 2024',
        },
      })
