    ...
    <div class="container relative">
      <div class="flex flex-col justify-between items-center sm:flex-row gap-12">
        <div class="flex flex-col space-y-4 xl:space-y-8 max-w-[740px]">
          ...
          >
            L’éducation est essentielle à tous les âges. Tout le mois de septembre, des
            organisations de toute la France unissent leurs forces pour la réussite scolaire,
            l’insertion professionnelle et les rêves d’enfants, devenus grands. Cours de soutien,
            mentorat, partage de connaissances… C’est le moment ou jamais de vous engager en tant
            que bénévole pour l’égalité des chances !
          </p>
        </div>
        <img
      ...
      <div class="mt-12">
        ...
        <AlgoliaSlideshowMissions
          ...
          :search-parameters="{
            ...
            facetFilters: [['tags:Septembre pour Apprendre']],
    ...
    onViewMoreClick() {
      this.$plausible.trackEvent('Homepage - CTA - Plus de missions - Opé nationale', {
        props: {
          ...
          operation: 'Septembre pour Apprendre',
        },
      })
