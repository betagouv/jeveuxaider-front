      ...
      <div class="flex flex-col justify-between items-center sm:flex-row gap-12">
        <div class="flex flex-col space-y-4 xl:space-y-8 max-w-[740px]">
          <p class="font-bold text-jva-blue-500 uppercase xl:text-xl">
            Luttons contre la précarité alimentaire
          </p>
          <DsfrHeading as="h2" size="alt-sm">
            <span>Rejoignez la Collecte Nationale des Banques Alimentaires</span>
          </DsfrHeading>
          <p
          ...
          >
            ...
            correctement. La précarité augmente, la solidarité aussi !
          </p>
        </div>
        <img
          src="/images/operations/operations-collecte-banques-alimentaires.png"
