<template>
  <div class="lg:flex justify-between items-center mt-8 lg:mb-4">
    <div class="hidden sm:flex flex-wrap items-center justify-start gap-3 lg:ml-6 xl:ml-12">
      <FacetFilterToggle facet-name="structure.name" label="Organisations">
      ...
      <FacetFilterToggle facet-name="publics_beneficiaires" label="Publics aidés">
        <template #button="{ firstValueSelected, activeValuesCount }">
          <BadgeFilter :is-active="!!activeValuesCount">
      ...
      <FacetFilterToggle facet-name="domaines" label="Domaines">
        <template #button="{ firstValueSelected, activeValuesCount }">
          <BadgeFilter :is-active="!!activeValuesCount">
      ...
      <FacetFilterToggle facet-name="structure.reseaux.name" label="Réseaux" options-class="right-0 md:left-0">
        <template #button="{ firstValueSelected, activeValuesCount }">
          <BadgeFilter :is-active="!!activeValuesCount">
      ...
      <FacetFilterToggle
        v-if="$route.query.type != 'Mission à distance'"
