<template>
  ...
  >
    ...
    <div class="relative">
      <DsfrHeading as="h2" size="2xl" class="mb-8"> Rejoignez la communauté </DsfrHeading>

      <p class="max-w-md lg:max-w-xl xl:max-w-[700px] text-lg sm:text-xl text-[#696974]">
        Devenez ambassadeur de l’engagement près de chez vous&nbsp;!
        <br class="hidden xl:block" />Rejoignez notre groupe de bénévoles engagés et motivés pour
        partager, s'inspirer, mobiliser et agir chacun pour tous.&nbsp;💪
      </p>
