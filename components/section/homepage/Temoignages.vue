<template>
  <section class="py-16 bg-[#ECECFE] overflow-hidden relative">
    ...
    <div class="container mx-auto px-4">
      <DsfrHeading :id="`label-paroles-benevoles-${uuid}`" as="h2" size="2xl" class="text-center">
      ...
      >
        <swiper-slide v-for="(testimony, index) in testimonies" :key="index">
          ...
          >
            <div
              class="flex-none rounded-full bg-white w-[184px] h-[184px] flex items-center justify-center"
            >
              <img
  ...
  data() {
    return {
      testimonies: [
        {
          content:
            'Experience très positive qui m\'a permise d\'être utile envers les autres, mais aussi de rencontrer des belles personnes. Je me suis désormais active dans la Banque Alimentaire près de chez moi deux matinées par semaine&nbsp;<span aria-hidden="true">🙂</span>',
          author: {
            name: 'Anne-Marie',
            image: {
        ...
        {
          content:
            "Une expérience formidable avec un super groupe de vacanciers et d'accompagnateurs. On s'est vite sentis comme en famille. Hâte de partir à nouveau avec l'APF l'année prochaine &nbsp;!",
          author: {
            name: 'Romain',
            image: {
        ...
        {
          content:
            'Superbe et enrichissante. En tant que bénévole arbitre j’ai rencontré des joueurs tolérants passionnés qui ont la passion au dessus de l’enjeu. Une expérience sans pareil.',
          author: {
            name: 'Romaric',
            image: {
          ...
          organization: {
            ...
            logo: {
              default:
                '/images/temoignages/organisations/comite_departemental_sport_adapte_drome_ardeche.webp',
              x2: null,
            },
          },
        },
        {
          content:
            'Très belle expérience, une magnifique équipe, de beaux moments passés, beau spectacle.',
          author: {
            name: 'Ange',
            image: {
        ...
        {
          content:
            "Bel échange et super accompagnement par l'équipe. On se sent utile et les ateliers sont super bien encadrés !",
          author: {
            name: 'Maud',
          },
          organization: {
        ...
        {
          content:
            'J’ai adoré cette expérience. L’équipe est formidable et les bénévoles sont tellement admirables. Pour une première, j’ai adoré. Un grand merci&nbsp;<span aria-hidden="true">🙏🏽</span>',
          author: {
            name: 'Kevin',
            image: {
        ...
        {
          content:
            "Très bonne expérience. J'ai pû voir l'organisation d'un bureau de vote. Et par la même occasion rencontrer des gens très sympathiques!",
          author: {
            name: 'Corinne',
          },
          organization: {
