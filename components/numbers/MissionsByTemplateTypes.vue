<template>
  <Box padding="sm" :loading="loading" loading-text="Générations des données...">
    <BoxHeadingStatistics title="Modèles de missions" class="mb-6" infos-bulle="Répartition des missions créées sur la période utilisant un modèle de mission ou non" />
    <div class="w-full">
