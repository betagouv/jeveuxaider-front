<template>
  <Box padding="sm" :loading="loading" loading-text="Générations des données...">
    <BoxHeadingStatistics title="Nouvelles missions postées par les organisations" subtitle="Répartition par mois et années" class="mb-6" />
    <div class="w-full">
...
export default {
  ...
  async fetch () {
    this.loading = true
    await this.$axios.get('/charts/missions-by-date', {
