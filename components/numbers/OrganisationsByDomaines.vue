<template>
  <Box padding="sm" :loading="loading" loading-text="Générations des données...">
    <BoxHeadingStatistics title="Répartition des organisations par domaine d’action" class="mb-6" infos-bulle="Répartition des organisations inscrites sur la période par domaine d'action" />
