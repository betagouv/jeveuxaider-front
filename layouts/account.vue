<template>
  <div class="h-full">
    ...
    <div class="container">
      ...
      <div class="grid lg:grid-cols-4 xl:grid-cols-5 gap-6 lg:gap-12 pb-6 lg:pb-12">
        <aside class="relative lg:col-span-1">
          <div class="lg:block">
            <SecondaryMenuUser />
          </div>
        </aside>
        <div class="lg:col-span-3 xl:col-span-4 min-w-0">
          <NuxtPage />
...
import SecondaryMenuUser from '@/components/menu/SecondaryMenuUser.vue'
